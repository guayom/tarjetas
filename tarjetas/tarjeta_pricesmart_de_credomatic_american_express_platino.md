---
sys:
  id: 5fMF6zUxfa220Q48AQQM4Q
nombre: Tarjeta PriceSmart de Credomatic
slug: tarjeta-pricesmart-de-credomatic
categoria:
  sys:
...
beneficios:
- sys:
    id: 3e0OUlqVdm2kOyimSMmYiG
  titulo: 10% de PriceCash por Cargo de Membresía
- sys:
    id: 5xFLcFGQPSQYoeWeWamkOM
  titulo: 4% de PriceCash por compras en pricesmart.com
- sys:
    id: 5OAAxN10CQAOOOeaWoqi4A
  titulo: 3% de PriceCash en Aerolíneas, Agencias de Viaje, Alquiler de Autos, Restaruantes
    y Hoteles
- sys:
    id: 1wKeuqYSVu4suQqio4QGm0
  titulo: 2% de PriceCash en Pricesmart
- sys:
    id: 3QMfj1XRxKE4AS6WeKywUA
  titulo: 1% de PriceCash En todos los comercios
- sys:
...
- sys:
  ...
  titulo: Servicios en línea 24 horas por medio de baccredomatic.com & a la Central
    Telefónica.
  general: true
breveDescripcion: Tarjeta de crédito Dual. Funciona como tarjeta de Crédito y como
  Tarjeta de Membresía para acceder a los Clubes Pricesmart
modalidadDeAcumulacion: |-
  $500 PriceCash Mensuales
  24 Meses Móviles
uso:
- Compras
- Compras online
...
imagenes:
  sys:
    id: 3ie6KNY2acC8Yy2s2EM86E
  titulo: Clásica
  imagen:
    title: tarjeta pricesmart clasica
    url: "//images.contentful.com/9cds0lha1plv/3mwdcPzGqAuc4cS6O6wCiK/c6f113d17b81683c15cf7f5db33c25cd/tarjeta_pricesmart_clasica.jpg"
  nivel:
    sys:
      id: Y59ZhDeJSoCW2yeM6oOU8
    titulo: Clásica
...
nivel: Platino
titulo: Tarjeta PriceSmart de Credomatic American Express Platino
